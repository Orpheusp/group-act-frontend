...
const mockGroup = {
  ...
  preferences: [
    { activityType: 20, activityScore: 15 },
    { activityType: 15, activityScore: 14 },
    { activityType: 12, activityScore: 13 },
    { activityType: 11, activityScore: 12 },
    { activityType: 13, activityScore: 11 },
    { activityType: 14, activityScore: 10 },
    { activityType: 5, activityScore: 9 },
    { activityType: 8, activityScore: 8 },
    { activityType: 9, activityScore: 7 },
    { activityType: 21, activityScore: 6 },
    { activityType: 24, activityScore: 5 },
    { activityType: 23, activityScore: 4 },
  ],
};
